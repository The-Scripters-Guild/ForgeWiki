...
While Halo Infinite is an arena shooter, Forge creations are not limited strictly to arena maps. Players can utilize the tools in Forge to build various experiences, including campaign scenarios, parkour courses, and minigames.

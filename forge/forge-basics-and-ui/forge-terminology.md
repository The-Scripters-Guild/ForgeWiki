...
* L**eaks B:** A colorable decal found in `Decals → Editable → Leaks B` that looks like a liquid leak. The object was the first of its kind, and thus gained high popularity among forgers. [Read more](forge-interface/object-browser/hidden-forge-objects.md#leaks-b).

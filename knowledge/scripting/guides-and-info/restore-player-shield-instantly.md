...
To minimize the delay before regeneration begins and maximize the recharge speed, use the following scalar values (compared to the default 5.000s cooldown and 2.000s recharge):

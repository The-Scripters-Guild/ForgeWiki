---
description: >-
  Spawns object clones that retain most properties from their source spawner,
  including physics and spawn order.
---
...
{% hint style="warning" %}
You cannot use the \`Spawn Mode Object\` node on an already cloned object; it must be used on an object that was created naturally in the scene, as the clones are instances instead of spawners.
{% endhint %}
...
* **Using Variables:** To fetch these clones from an [Object Variable](../variables-advanced/object-variable.md) or [Object List Variable](../variables-advanced/object-list-variable.md), you must use [Get Object Variable Without Refresh](../variables-advanced/object-variable.md#get-object-variable-without-refresh) or [Get Object List Variable Without Refresh](../variables-advanced/object-list-variable.md#get-object-list-variable-without-refresh). These nodes specifically reference the created object instances.
  * _Note:_ Using a standard [Get Object Variable](../variables-advanced/object-variable.md#get-object-variable) node will fetch the original spawner rather than the spawned instance.

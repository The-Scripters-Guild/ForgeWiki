...
![](../../../.gitbook/assets/declare-wave-variable.JPG)

## Description

Declare a Wave variable with a custom Identifier. Variable declarations do not require an event node to trigger. They are automatically performed when the node graph script is run.
...
| Initial Value | Wave   | No       | What the variable holds when the game starts.                                                                                                                                                                           |
...
![](../../../.gitbook/assets/get-wave-variable.JPG)
...
| Output | Type | Description                     |
| ------ | ---- | ------------------------------- |
| Value  | Wave | Current value of this variable. |
...
![](../../../.gitbook/assets/set-wave-variable.JPG)
...
| ---------- | ------ | -------- | -------------------------------------------------------------------- |
| Identifier | String | Yes      | The custom string id for this variable.                              |
| Value      | Wave   | Yes      | The new value for this variable.                                     |
| Scope      | Scope  | Yes      | Must match scope of declared variable with the same identifier.      |
| Object     | Object | No       | Used to associate variable with an object when Object scope is used. |

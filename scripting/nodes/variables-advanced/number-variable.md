...
![](../../../.gitbook/assets/declare-number-variable.JPG)

## Description

Declare an Number variable with a custom Identifier. Variable declarations do not require an event node to trigger. They are automatically performed when the node graph script is run.
...
| Initial Value | Number | No       | What the variable holds when the game starts.                                                                                                                                                                           |
...
![](../../../.gitbook/assets/get-number-variable.JPG)

## Description

Get the Number variable stored with the matching Identifier in the matching Scope. The Object pin is only used when accessing the Object scope.
...
| Output | Type   | Description                     |
| ------ | ------ | ------------------------------- |
| Value  | Number | Current value of this variable. |
...
![](../../../.gitbook/assets/set-number-variable.JPG)

## Description

Set the Number variable stored with the matching Identifier in the matching Scope. The Object pin is only used when accessing the Object scope.
...
| ---------- | ------ | -------- | -------------------------------------------------------------------- |
| Identifier | String | Yes      | The custom string id for this variable.                              |
| Value      | Number | Yes      | The new value for this variable.                                     |
| Scope      | Scope  | Yes      | Must match scope of declared variable with the same identifier.      |
| Object     | Object | No       | Used to associate variable with an object when Object scope is used. |
